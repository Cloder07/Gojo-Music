...
from Gojo import call_py, Gojo, client as Client
owner = "6295636206"
from Gojo.helpers.yt_dlp import bash
from Gojo.helpers.chattitle import CHAT_TITLE
from Gojo.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Gojo.helpers.thumbnail import gen_thumb
from Gojo.helpers.joiner import AssistantAdd
...
@Gojo.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@Gojo.on(events.NewMessage(pattern="^[?!/]play"))
@AssistantAdd
...
@Gojo.on(events.NewMessage(pattern="^[/?!]end"))
@is_admin
...
@Gojo.on(events.NewMessage(pattern="^[?!/]vplay"))
@AssistantAdd
...
#playlist
@Gojo.on(events.NewMessage(pattern="^[?!/]playlist"))
@is_admin
...
#leavevc
@Gojo.on(events.NewMessage(pattern="^[?!/]leavevc"))
@is_admin
...
@Gojo.on(events.NewMessage(pattern="^[?!/]skip"))
@is_admin
...
@Gojo.on(events.NewMessage(pattern="^[?!/]pause"))
@is_admin
...
@Gojo.on(events.NewMessage(pattern="^[?!/]resume"))
@is_admin
